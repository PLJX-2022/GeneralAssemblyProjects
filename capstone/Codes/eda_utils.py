...
def clean_string(text, stem="none"):
    ...
    stopwords=stopwords + ["description", "requirement", "responsibility", "singapore", "duty", "work", "driver", "job", "company", "experience"]
    ...
    # spaCy lemmatization. spaCy determines the part-of-speech tag by default and assigns the corresponding lemma
        ...
        text_stemmed = [word for word in text_stemmed if not word in stopwords]
    else:
